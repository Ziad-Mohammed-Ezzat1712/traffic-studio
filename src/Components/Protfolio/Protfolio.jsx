    ...
    <div className="flex justify-center">
      <section className="w-full max-w-screen-2xl px-4 md:px-16 xl:px-32 py-12 bg-white">
        ...
        <div className="flex flex-col md:flex-row justify-between  items-center mb-10 gap-4">
          ...
          <button className="border border-black text-black rounded-full px-6 py-2 hover:bg-black hover:text-white transition duration-300 flex items-center gap-2">
            View All Project <span className="text-xl">→</span>
          </button>
        </div>
